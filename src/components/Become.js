  ...
  return (
    ...
    <><Header /><div className="flex justify-center">
      ...
      <div className="w-1/2 flex flex-col pb-12">
        ...
        <button type="button" onClick="" className="font-bold mt-4 bg-blue-700 text-white rounded p-4 shadow-lg">
          Register
        </button>
      </div>
    </div><div className="text-4xl text-center text-white font-bold mt-10">
